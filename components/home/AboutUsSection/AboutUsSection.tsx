  ...
  return (
    ...
    >
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch lg:gap-10">
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-emerald-950 via-emerald-800 to-green-700 p-7 text-white shadow-[0_24px_70px_rgba(6,78,59,0.22)] sm:p-10 lg:p-12">
        ...
        <div className="rounded-[32px] border border-emerald-100 bg-white p-6 shadow-[0_24px_70px_rgba(31,46,77,0.08)] sm:p-8 lg:p-10">
